...
@section('admin_title', 'NASIM NEWS | DISTRICT')
@section('admin_main_section')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-table"></i>District List</h3>
                    <div class="box-tool">
                        <a href="{{ route('district.create') }}" class="btn btn-md" style="background-color: black;"><i
                            ...
                            <tbody>
                                @foreach ($districts as $key => $district)
                                    <tr class="table-flag-blue">
                                        ...
                                        <td>
                                            <a href="{{route('category.edit',$district->id)}}"><i class="fas fa-edit text-primary"></i></a>
