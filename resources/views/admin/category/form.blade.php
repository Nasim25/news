...
@section('admin_main_section')
    ...
    <div class="row" style="min-height: 437px;">
        <div class="col-md-8">
            <div class="box">
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i> Category Create</h3>

                </div>
                <div class="box-content">
                    <form action="{{route('category.store')}}" class="form-horizontal" id="validation-form" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-9 controls">
                                <input type="text" name="category_bn" id="category_bn" class="form-control"
                                    data-rule-required="true" data-rule-minlength="3" />
                                    @error('category_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
