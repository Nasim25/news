...
@section('admin_title', 'NASIM NEWS | ADMIN')
...
<div class="row">
            ...
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tile">
                            ...
                            <p>Based on twitter bootstrap, 9 predefined color, clean and minimal design,
                                easy to change and etc.</p>
                ...
                <div class="row">
                    <div class="col-md-6 tile-active">
                        <a class="tile tile-pink" data-stop="3000"
                            href="http://codecanyon.net/item/flaty-wp-premium-wordpress-flat-admin-template/5329999">
                            <div class="img img-center">
                                <img src="{{ asset('backend/') }}/demo/wp-logo.png" />
                            </div>
                            <p class="title text-center">Visit FLATY wp</p>
                        </a>

                        <a class="tile tile-orange"
                            href="http://codecanyon.net/item/flaty-wp-premium-wordpress-flat-admin-template/5329999">
                    ...
                    <div class="col-md-6">
                        <a class="tile tile-red"
                            href="http://themeforest.net/item/flaty-premium-responsive-admin-template/5247864">
                            <div class="img img-center">
    ...
    <div class="col-md-5">
        ...
        <div class="row">
            <div class="col-md-12 tile-active">
                <div class="tile tile-img" data-stop="3500"
                    style="background-image: url({{ asset('backend/') }}/img/demo/gallery/5.jpg);">
                    <p class="title">Gallery</p>
                </div>

                <a class="tile tile-lime" data-stop="5000" href="gallery.html">
                    <p class="title">Gallery page</p>
                    <p>Click on this tile block to see our amazing gallery page. Lorem ipsum dolor sit amet,
                ...
                <ul class="messages slimScroll" style="height: 300px">
                    <li>
                        ...
                        <div>
                            ...
                            <p>Lorem ipsum commodo quis dolor voluptate et in Excepteur. Lorem ipsum amet
                                dolor qui cupidatat in anim reprehenderit quis id culpa consequat non culpa.
                                Lorem ipsum in culpa aliquip incididunt cupidatat dolore irure ...</p>
                            <div class="messages-actions">
                                <a class="show-tooltip" href="#" title="Approve"><i
                                        class="fa fa-check green"></i></a>
                                <a class="show-tooltip" href="#" title="Disapprove"><i
                                        class="fa fa-times orange"></i></a>
                                <a class="show-tooltip" href="#" title="Remove"><i
                                        class="fa fa-trash-o red"></i></a>
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p>Lorem ipsum commodo quis dolor voluptate et in Excepteur. Lorem ipsum amet
                                dolor qui cupidatat in anim reprehenderit quis id culpa consequat non culpa.
                                Lorem ipsum in culpa aliquip incididunt cupidatat dolore irure cupidatat
                                aute cupidatat quis nulla.</p>
                            <div class="messages-actions">
                                <a class="show-tooltip" href="#" title="Approve"><i
                                        class="fa fa-check green"></i></a>
                                <a class="show-tooltip" href="#" title="Disapprove"><i
...
<div class="row">
    <div class="col-md-7">
        <div class="box box-pink">
            ...
            <div class="box-content">
                <ul class="messages messages-chat messages-stripped messages-zigzag slimScroll"
                    style="height:250px">
                    <li>
                        <img src="img/demo/avatar/avatar1.jpg" alt="">
                        <div>
                ...
                <div class="messages-input-form">
                    <form method="POST" action="#">
                        ...
                        <div class="buttons">
                            <a class="show-tooltip" href="#" title="Take Picture"><i
                                    class="fa fa-camera"></i></a>
                            <a class="show-tooltip" href="#" title="Attach File"><i
                ...
                <ul class="todo-list">
                    <li>
                        ...
                        <div class="todo-actions">
                            ...
                            <a class="show-tooltip" href="#" title="It's done"><i
